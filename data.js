...
const ID_CARD_GROUPS = [
  {
    ...
    fields: [
      ...
      { code: "1.5", label: "מרחב" },
      { code: "1.7", label: 'ק"מ התחלה', step: 1, round: "near", hint: 'מיקום בק"מ — מספר בן 6 ספרות' },
  ...
  },
  {
    ...
    fields: [
      { code: "3.1", label: "שנת בניה", step: 1, round: "near", hint: "שנה (4 ספרות)" },
      { code: "3.2", label: "שנת שיקום אחרון", step: 1, round: "near", hint: "שנה (4 ספרות)" },
      ...
      { code: "3.5", label: 'מספר מסלולים ו/או מסילות רכבת מעל', step: 1, round: "near" },
      { code: "3.6", label: "מספר נתיבים מעל", step: 1, round: "near" },
      ...
      { code: "3.10", label: 'מספר מסלולים ו/או מסילות רכבת מתחת', step: 1, round: "near" },
      { code: "3.11", label: "מספר נתיבים מתחת", step: 1, round: "near" },
      { code: "3.12", label: "כיוון תנועה מתחת" },
      { code: "3.13", label: "נפח תנועה יומי AADT", unit: "רכבים ליום", step: 1, round: "near" },
      { code: "3.14", label: "שנת מדידת AADT אחרונה", step: 1, round: "near", hint: "שנה (4 ספרות)" },
      // לפי המדריך: אחוז המשאיות מתוך התנועה היומית (למשל 5% ⇐ הערך 5), ולא מספר רכבים
      { code: "3.15", label: "נפח תנועה יומי - משאיות (%)", unit: "%", step: 1, round: "near", max: 100 },
      { code: "3.16", label: "מעקף בדרכים קיימות" },
      { code: "3.17", label: "אורך מעקף", unit: 'ק"מ', step: 1, round: "up" },
  ...
  },
  {
    ...
    // שדות מדידה: step = רזולוציית המדידה הנדרשת, round = כיוון העיגול —
    // שניהם מתוך "מדריך לתיעוד גשרים, מנהרות ומבני דרך" (מהדורה 5-2019),
    // סעיף 4. שימו לב שגם שדות "מינימלי" של רוחב מעוגלים כלפי מעלה; רק
    // מרווחים חופשיים (אנכיים/אופקיים) ורוחבי מסלול מעוגלים כלפי מטה.
    fields: [
      { code: "4.2", label: "אורך מפתח מרבי", unit: "מ'", step: 0.1, round: "up" },
      { code: "4.3", label: "אורך מבנה כללי", unit: "מ'", step: 0.1, round: "up" },
      { code: "4.4", label: "אורך ימין", unit: "מ'", step: 0.1, round: "up" },
      { code: "4.5", label: "אורך שמאל", unit: "מ'", step: 0.1, round: "up" },
      { code: "4.6", label: "חלוקת מפתחים", placeholder: 'למשל 15-30-15' },
      { code: "4.7", label: "שינוי רוחב קיים" },
      { code: "4.8", label: 'רוחב חיצוני מינימלי ניצב לציר הדרך (לגשרים בלבד)', unit: "מ'", step: 0.1, round: "up" },
      { code: "4.9", label: 'רוחב חיצוני מכסימלי ניצב לציר הדרך (לגשרים בלבד)', unit: "מ'", step: 0.1, round: "up" },
      { code: "4.10", label: "רוחב חיצוני מכסימלי", unit: "מ'", step: 0.1, round: "up" },
      { code: "4.11", label: "רוחב חיצוני מינימלי", unit: "מ'", step: 0.1, round: "up" },
      { code: "4.12", label: "רוחב הגבהות ומדרכות (1)", unit: "מ'", step: 0.05, round: "up" },
      { code: "4.13", label: "רוחב הגבהות ומדרכות (2)", unit: "מ'", step: 0.05, round: "up" },
      { code: "4.14", label: "רוחב מסלול מינימלי (בין הגבהות)", unit: "מ'", step: 0.05, round: "down" },
      { code: "4.15", label: "רוחב מסלול כולל (מהגבהה להגבהה)", unit: "מ'", step: 0.05, round: "down" },
      { code: "4.16", label: "סוג מפרדה" },
      { code: "4.17", label: "זווית ייחוס (Skew)", unit: "מעלות", step: 1, round: "near" },
      { code: "4.18", label: "מרווח אנכי חופשי מינימלי", unit: "מ'", step: 0.05, round: "down" },
      { code: "4.19", label: "מרווח אנכי חופשי", unit: "מ'", step: 0.05, round: "down" },
      { code: "4.20", label: "מרווח אנכי חופשי מינימלי (2)", unit: "מ'", step: 0.05, round: "down" },
      // ערך מועתק כלשונו מהשלט בפועל (הנמוך מביניהם אם יש כמה) — לא נמדד, ולכן לא מעוגל
      { code: "4.21", label: "שילוט מגבלת גובה", unit: "מ'", step: 0.01,
        hint: 'מ\' · הערך הכתוב על השלט; אם יש כמה שלטים — הנמוך מביניהם' },
      { code: "4.22", label: "מרווח אופקי מינימלי", unit: "מ'", step: 0.1, round: "down" },
      { code: "4.23", label: "גובה נציב מכסימלי", unit: "מ'", step: 0.05, round: "up" },
      { code: "4.29", label: "שטח מיסעה", unit: 'מ"ר', step: 0.1 },
    ],
  },
  {
    id: "classification", label: "סיווגים",
    fields: [
      { code: "5.1", label: "מספר סוגי מבנה עליון/מיסעה/תקרה", step: 1, round: "near", hint: "ספרה אחת" },
      ...
      { code: "5.6", label: "מספר סוגי נציבי ביניים", step: 1, round: "near", hint: "ספרה אחת" },
  ...
  },
  {
    ...
    fields: [
      ...
      { code: "9.1", label: "מפלס יחסי מתוכנן מירבי", unit: "מ'", step: 0.1, round: "up" },
      { code: "9.2", label: "תקופת חזרה הידראולית", unit: "שנים", step: 1, round: "near" },
  ...
  },
  {
    ...
    fields: [
      { code: "11.1", label: "ערך הסמן Availability PI", step: 1, round: "near", max: 100, hint: "0–100" },
      { code: "12.1", label: "ערך הסמן Reliability PI", step: 1, round: "near", max: 100, hint: "0–100" },
